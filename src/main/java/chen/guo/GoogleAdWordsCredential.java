...
import chen.guo.GoogleAdWordsSource;
...
public class GoogleAdWordsCredential {
  ...
  public static void main(String[] args)
    ...
    GoogleAdWordsCredential credential =
        new GoogleAdWordsCredential(prop.getProperty(GoogleAdWordsSource.KEY_DEVELOPER_TOKEN),
            prop.getProperty(prop.getProperty("SOURCE_ENTITY")), prop.getProperty(GoogleAdWordsSource.KEY_CLIENT_ID),
  ...
  public GoogleAdWordsCredential() {
    _developerToken = "";
    _refreshToken = "";
